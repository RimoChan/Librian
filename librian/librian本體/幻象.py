...
def 生成虛擬核心():
    圖片文件夾 = 路徑.相對adv網頁處(虛擬機環境.工程路徑 / 虛擬機環境.圖片文件夾)
    音樂文件夾 = 路徑.相對adv網頁處(虛擬機環境.工程路徑 / 虛擬機環境.音樂文件夾)
    視頻文件夾 = 路徑.相對adv網頁處(虛擬機環境.工程路徑 / 虛擬機環境.視頻文件夾)
    臨時立繪文件夾 = 路徑.相對adv網頁處(虛擬機環境.工程路徑 / 虛擬機環境.臨時立繪文件夾)
    自定css = [路徑.相對adv網頁處(虛擬機環境.工程路徑 / i) for i in 虛擬機環境.自定css]
