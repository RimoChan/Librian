        ...
        for 圖 in 人['圖層']:
            ...
            if 動作:
                ...
                if 動作[0]=='移動':
                    原位置=動作[1]
                    新位置=動作[2]
                    原x=原位置[0]+圖['子位置'][0]*縮放*輕文縮放
                    原y=原位置[1]+圖['子位置'][1]*縮放*輕文縮放
                    原縮放=原位置[2]*100*輕文縮放
                    新x=新位置[0]+圖['子位置'][0]*縮放*輕文縮放
                    新y=新位置[1]+圖['子位置'][1]*縮放*輕文縮放
                    新縮放=新位置[2]*100*輕文縮放
                    t+=f'@action CHR{層數} x={原x} time=0\n'
                    t+=f'@action CHR{層數} y={原y} time=0\n'
                    t+=f'@action CHR{層數} zoom={原縮放} time=0\n'
                    t+=f'@action CHR{層數} x={新x} time=400\n'
                    t+=f'@action CHR{層數} y={新y} time=400\n'
                    t+=f'@action CHR{層數} zoom={新縮放} time=400\n'
